      ...
      if (action.type !== _constants.REHYDRATE) return reducer(state, action);else {
        var _ret = (function () {
          ...
          Object.keys(inboundState).forEach(function (key) {
            ...
            if (statesArePlain(inboundState[key], reducedState[key])) newState[key] = _extends({}, state[key], inboundState[key]); // shallow merge
...
function statesArePlain(a, b) {
  return _lodashIsplainobject2['default'](a) && _lodashIsplainobject2['default'](b);
}