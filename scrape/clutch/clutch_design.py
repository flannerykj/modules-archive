...
def get_page_urls():
    agency_array = []
    agency_count = 1
    url = 'https://clutch.co/web-designers'
    print url
    try: 
...
outfile = open("./clutch_design_agencies.csv", "wb")
